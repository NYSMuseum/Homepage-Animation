...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {   
      ...
      Symbol.bindSymbolAction(compId, symbolName, "creationComplete", function(sym, e) {
         ...
         //var paraCopy = sym.$("paraCopy");
         //paraCopy.html('Combining Edge Animate\'s timeline animation, Greensock\'s Draggable utility and the awesome <a style=\'text-decoration:none;\' title=\'GSAP ThrowProps\'  href=\'http://www.greensock.com/throwprops\'><span style=\'color:#AE474A\'>ThrowProps</span></a> plugin means performance matches flexibility.');
