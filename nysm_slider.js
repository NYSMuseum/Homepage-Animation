...
(lib.erieblue = function() {
	this.initialize(img.erieblue);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1000,400);


(lib.eriebluestrip = function() {
	this.initialize(img.eriebluestrip);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,488,33);


(lib.erieboat = function() {
	this.initialize(img.erieboat);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,302,339);


(lib.eriehouse = function() {
	this.initialize(img.eriehouse);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,157,150);


(lib.eriewaterground = function() {
	this.initialize(img.eriewaterground);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,990,40);
...
p.nominalBounds = new cjs.Rectangle(0,0,346,274);
...
p.nominalBounds = new cjs.Rectangle(0,0,598,21);


(lib.title = function() {
	this.initialize(img.title);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,393,204);


(lib.titlepngcopy = function() {
	this.initialize(img.titlepngcopy);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,356,327);


(lib.votesforwomenmural = function() {
	this.initialize(img.votesforwomenmural);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,2654,350);


(lib.waterstrip = function() {
	this.initialize(img.waterstrip);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,404,33);


(lib.white3 = function() {
	this.initialize(img.white3);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,282,239);// helper functions:
...
(lib.Tween64 = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f("#2F3E77").s().dr(-165.65,-189,331.3,378);
	this.shape.setTransform(0,0,1,1.058);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-165.6,-200,331.3,400.1);
...
(lib.Tween62 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.instance = new lib.titlepngcopy();
	this.instance.parent = this;
	this.instance.setTransform(-178,-163.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-178,-163.5,356,327);
...
(lib.Tween60 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.instance = new lib.votesforwomenmural();
	this.instance.parent = this;
...
p.nominalBounds = new cjs.Rectangle(-1327,-175,2654,350);
...
(lib.Tween59 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.instance = new lib.eriewaterground();
	this.instance.parent = this;
	this.instance.setTransform(-495,-20);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-495,-20,990,40);
...
(lib.Tween58 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.instance = new lib.eriebluestrip();
	this.instance.parent = this;
	this.instance.setTransform(-244,-16.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-244,-16.5,488,33);
...
(lib.Tween57 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.instance = new lib.waterstrip();
	this.instance.parent = this;
	this.instance.setTransform(-202,-17);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-202,-17,404,33);
...
(lib.Tween55 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#406991").s().p("");
	this.shape.setTransform(0,-0.3,0.336,0.336,15);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-9.7,-11.4,19.5,22.9);
...
p.nominalBounds = new cjs.Rectangle(-12.1,-9.1,24.3,18.2);
...
(lib.Tween50 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#406991").s().p("");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-16.1,-19.8,32.2,39.7);
...
(lib.Tween16 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AgxBlIAAgMIAGAAQALgBAGgEQAEgDAFgMIALgeIgziMIAQAAIApB6IAqh6IAQAAIhACxQgEAMgFAFQgKAJgRgBg");
	this.shape.setTransform(148.6,3.8);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AgsBHIAAiLIAPAAIAAATQANgVAbAAQAUAAAOAOIgLAKQgLgLgPAAQgRAAgKANQgKAMAAASIAABVg");
	this.shape_1.setTransform(134.8,0.6);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("Ag3AAQAAghAPgSQAPgUAZABQAagBAPATQAPARAAAgIAAAGIhgAAQAAA3AsAAQAWABARgSIALAJQgWAWgcAAQg7AAAAhIgAApgHQAAgQgEgLQgGgLgJgGQgKgGgMgBQgLABgKAGQgKAGgEALQgFALAAAQIBRAAIAAAAg");
	this.shape_2.setTransform(117,0.7);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AAKBnQggAAAAgkIAAipIAPAAIAACpQAAAMAEAFQAEAGAMAAIAKAAIAAANg");
	this.shape_3.setTransform(103.2,-2.7);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AAKBnQggAAAAgkIAAipIAPAAIAACpQAAAMAEAFQAEAGAMAAIAKAAIAAANg");
	this.shape_4.setTransform(91.9,-2.7);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AgrA7QgKgLAAgQQAAgUAMgKQANgJAXAAIAsAAIAAgRQAAgignAAQgaABgMARIgKgJQAPgWAhABQA2gBAAAvIAABeIgPAAIAAgOQgPAQgaAAQgdAAgMgNgAgnAfQAAAbAlAAQAXAAALgKQAHgHAAgUIAAgSIgqAAQgkAAAAAcg");
	this.shape_5.setTransform(75.7,0.7);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AgzBUQgNgNgDgTQgDgNAAgnQAAgmADgNQADgTANgNQAVgVAeAAQAbAAATARQAUAQAEAbIgPAAQgFgVgPgNQgOgMgVAAQgWAAgQAQQgLAKgDAQQgCANAAAjQAAAkACANQADAQALAKQAQAQAWAAQAaAAARgUQAMgPAAgaIAAgSIg3AAIAAgNIBHAAIAAAgQAAAggRASQgVAYghAAQgeAAgVgVg");
	this.shape_6.setTransform(56.3,-2.7);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AgxBlIAAgMIAGAAQALgBAGgEQAEgDAFgMIALgeIgziMIAQAAIApB6IAqh6IAQAAIhACxQgEAMgFAFQgKAJgRgBg");
	this.shape_7.setTransform(27.2,3.8);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AAnBnIAAhWQAAgpgmAAQgSAAgLALQgKALAAATIAABWIgPAAIAAjNIAPAAIAABTQAQgSAYAAQAYAAAOAOQAOAOAAAXIAABZg");
	this.shape_8.setTransform(10,-2.7);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("Ag1BoIAAjOIAPAAIAAASQAPgTAZAAQAWAAAMAMQASASAAApQAAApgSASQgMAMgWAAQgZAAgPgUIAABVgAgfhHQgHANAAAaQAAAbAHANQAJASAWAAQAXAAAKgSQAHgNAAgbQAAgagHgNQgKgTgXAAQgWAAgJATg");
	this.shape_9.setTransform(-8.6,3.9);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AgrA7QgKgLAAgQQAAgUAMgKQANgJAXAAIAsAAIAAgRQAAgignAAQgaABgMARIgKgJQAPgWAhABQA2gBAAAvIAABeIgPAAIAAgOQgPAQgaAAQgdAAgMgNgAgnAfQAAAbAlAAQAXAAALgKQAHgHAAgUIAAgSIgqAAQgkAAAAAcg");
	this.shape_10.setTransform(-27.9,0.7);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AgsBHIAAiLIAPAAIAAATQANgVAbAAQAUAAAOAOIgLAKQgLgLgPAAQgRAAgKANQgKAMAAASIAABVg");
	this.shape_11.setTransform(-42.6,0.6);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AgbBkQgJgEgMgJIAKgLQAJAJAGADQAJAEAMAAQAUAAALgOQAKgNAAgVIAAgaQgOAUgaAAQgWAAgMgMQgSgSAAgpQAAgpASgSQAMgMAWAAQAaAAAOATIAAgSIAPAAIAACUQAAAagPARQgPARgaAAQgPAAgKgFgAgghIQgGANAAAaQAAAbAGANQAKASAWAAQAXAAAKgSQAGgNAAgbQAAgagGgNQgKgTgXAAQgWAAgKATg");
	this.shape_12.setTransform(-61.1,4);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AgmA4QgRgRAAgnQAAgmARgRQAQgPAWAAQAXAAAQAPQARARAAAmQAAAngRARQgQAQgXAAQgWAAgQgQgAgcgtQgMAMAAAhQAAAjAMAMQAMALAQAAQARAAAMgLQAMgMAAgjQAAghgMgMQgMgMgRgBQgQABgMAMg");
	this.shape_13.setTransform(-79.1,0.7);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("AAUBcQgQAAgIgKQgJgKAAgQIAAhbIgTAAIAAgMIATAAIAAgsIAOAAIAAAsIAgAAIAAAMIggAAIAABbQAAAXAWAAIAKAAIAAANg");
	this.shape_14.setTransform(-94.6,-1.6);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#FFFFFF").s().p("AgmA4QgRgRAAgnQAAgmARgRQAQgPAWAAQAXAAAQAPQARARAAAmQAAAngRARQgQAQgXAAQgWAAgQgQgAgcgtQgMAMAAAhQAAAjAMAMQAMALAQAAQARAAAMgLQAMgMAAgjQAAghgMgMQgMgMgRgBQgQABgMAMg");
	this.shape_15.setTransform(-109.8,0.7);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FFFFFF").s().p("AAnBnIAAhWQAAgpgmAAQgSAAgLALQgKALAAATIAABWIgPAAIAAjNIAPAAIAABTQAQgSAYAAQAYAAAOAOQAOAOAAAXIAABZg");
	this.shape_16.setTransform(-128.4,-2.7);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#FFFFFF").s().p("AhEBnIAAjNIBLAAQAbAAARAPQASARAAAbQAAAcgSAPQgRAQgbAAIg7AAIAABXgAg0ACIA5AAQAWAAANgKQAOgMAAgXQAAgWgOgMQgNgLgWAAIg5AAg");
...
(lib.Symbol6 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#406991").s().p("");
	this.shape.setTransform(13.7,11.4,0.468,0.468);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol6, new cjs.Rectangle(0,0,27.3,22.7), null);
...
(lib.right3_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer 1
	this.instance = new lib.right3();
	this.instance.parent = this;
...
(lib.erietitle = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
(lib.eriehouse_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer 1
	this.instance = new lib.eriehouse();
	this.instance.parent = this;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.eriehouse_1, new cjs.Rectangle(0,0,157,150), null);


(lib.eriecloud1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer 1
	this.instance = new lib.white3();
	this.instance.parent = this;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,282,239);


(lib.erieboat_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer 1
	this.instance = new lib.erieboat();
	this.instance.parent = this;
...
(lib.votesforwomen = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(347).call(this.frame_347).wait(13));

	// Layer_3
	this.instance = new lib.Tween61("synched",0);
	this.instance.parent = this;
	this.instance.setTransform(730,196.5);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.instance_1 = new lib.Tween62("synched",0);
	this.instance_1.parent = this;
	this.instance_1.setTransform(730,196.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance}]},49).to({state:[{t:this.instance_1}]},29).to({state:[{t:this.instance_1}]},281).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(49).to({_off:false},0).to({_off:true,alpha:1},29).wait(282));

	// Layer_4
	this.instance_2 = new lib.Tween63("synched",0);
	this.instance_2.parent = this;
	this.instance_2.setTransform(730,200);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.instance_3 = new lib.Tween64("synched",0);
	this.instance_3.parent = this;
	this.instance_3.setTransform(730,200);
	this.instance_3.alpha = 0.879;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_2}]},49).to({state:[{t:this.instance_3,p:{alpha:0.879}}]},29).to({state:[{t:this.instance_3,p:{alpha:1}}]},281).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(49).to({_off:false},0).to({_off:true,alpha:0.879},29).wait(282));

	// Layer_2
	this.instance_4 = new lib.Tween60("synched",0);
	this.instance_4.parent = this;
	this.instance_4.setTransform(-327.9,200,1.143,1.143);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(1).to({x:-326.4},0).wait(1).to({x:-324.3},0).wait(1).to({x:-322.1},0).wait(1).to({x:-319.6},0).wait(1).to({x:-317},0).wait(1).to({x:-314.3},0).wait(1).to({x:-311.5},0).wait(1).to({x:-308.6},0).wait(1).to({x:-305.6},0).wait(1).to({x:-302.5},0).wait(1).to({x:-299.4},0).wait(1).to({x:-296.2},0).wait(1).to({x:-292.9},0).wait(1).to({x:-289.5},0).wait(1).to({x:-286.1},0).wait(1).to({x:-282.6},0).wait(1).to({x:-279},0).wait(1).to({x:-275.4},0).wait(1).to({x:-271.8},0).wait(1).to({x:-268},0).wait(1).to({x:-264.2},0).wait(1).to({x:-260.3},0).wait(1).to({x:-256.4},0).wait(1).to({x:-252.4},0).wait(1).to({x:-248.4},0).wait(1).to({x:-244.3},0).wait(1).to({x:-240.1},0).wait(1).to({x:-235.9},0).wait(1).to({x:-231.6},0).wait(1).to({x:-227.2},0).wait(1).to({x:-222.8},0).wait(1).to({x:-218.3},0).wait(1).to({x:-213.8},0).wait(1).to({x:-209.2},0).wait(1).to({x:-204.5},0).wait(1).to({x:-199.8},0).wait(1).to({x:-195},0).wait(1).to({x:-190.1},0).wait(1).to({x:-185.2},0).wait(1).to({x:-180.2},0).wait(1).to({x:-175.2},0).wait(1).to({x:-170},0).wait(1).to({x:-164.9},0).wait(1).to({x:-159.6},0).wait(1).to({x:-154.3},0).wait(1).to({x:-148.9},0).wait(1).to({x:-143.4},0).wait(1).to({x:-138},0).wait(1).to({x:-132.5},0).wait(1).to({x:-127},0).wait(1).to({x:-121.5},0).wait(1).to({x:-116},0).wait(1).to({x:-110.4},0).wait(1).to({x:-104.9},0).wait(1).to({x:-99.3},0).wait(1).to({x:-93.8},0).wait(1).to({x:-88.2},0).wait(1).to({x:-82.6},0).wait(1).to({x:-77.1},0).wait(1).to({x:-71.5},0).wait(1).to({x:-65.9},0).wait(1).to({x:-60.3},0).wait(1).to({x:-54.6},0).wait(1).to({x:-49},0).wait(1).to({x:-43.4},0).wait(1).to({x:-37.8},0).wait(1).to({x:-32.1},0).wait(1).to({x:-26.5},0).wait(1).to({x:-20.8},0).wait(1).to({x:-15.1},0).wait(1).to({x:-9.5},0).wait(1).to({x:-3.8},0).wait(1).to({x:1.9},0).wait(1).to({x:7.6},0).wait(1).to({x:13.3},0).wait(1).to({x:19},0).wait(1).to({x:24.7},0).wait(1).to({x:30.4},0).wait(1).to({x:36.1},0).wait(1).to({x:41.8},0).wait(1).to({x:47.5},0).wait(1).to({x:53.2},0).wait(1).to({x:59},0).wait(1).to({x:64.7},0).wait(1).to({x:70.4},0).wait(1).to({x:76.2},0).wait(1).to({x:81.9},0).wait(1).to({x:87.7},0).wait(1).to({x:93.4},0).wait(1).to({x:99.2},0).wait(1).to({x:104.9},0).wait(1).to({x:110.7},0).wait(1).to({x:116.4},0).wait(1).to({x:122.2},0).wait(1).to({x:128},0).wait(1).to({x:133.7},0).wait(1).to({x:139.5},0).wait(1).to({x:145.3},0).wait(1).to({x:151.1},0).wait(1).to({x:156.9},0).wait(1).to({x:162.6},0).wait(1).to({x:168.4},0).wait(1).to({x:174.2},0).wait(1).to({x:180},0).wait(1).to({x:185.8},0).wait(1).to({x:191.6},0).wait(1).to({x:197.4},0).wait(1).to({x:203.2},0).wait(1).to({x:209},0).wait(1).to({x:214.8},0).wait(1).to({x:220.6},0).wait(1).to({x:226.4},0).wait(1).to({x:232.2},0).wait(1).to({x:238},0).wait(1).to({x:243.8},0).wait(1).to({x:249.6},0).wait(1).to({x:255.4},0).wait(1).to({x:261.2},0).wait(1).to({x:267},0).wait(1).to({x:272.9},0).wait(1).to({x:278.7},0).wait(1).to({x:284.5},0).wait(1).to({x:290.3},0).wait(1).to({x:296.1},0).wait(1).to({x:301.9},0).wait(1).to({x:307.8},0).wait(1).to({x:313.6},0).wait(1).to({x:319.4},0).wait(1).to({x:325.2},0).wait(1).to({x:331},0).wait(1).to({x:336.9},0).wait(1).to({x:342.7},0).wait(1).to({x:348.5},0).wait(1).to({x:354.3},0).wait(1).to({x:360.1},0).wait(1).to({x:366},0).wait(1).to({x:371.8},0).wait(1).to({x:377.6},0).wait(1).to({x:383.4},0).wait(1).to({x:389.2},0).wait(1).to({x:395.1},0).wait(1).to({x:400.9},0).wait(1).to({x:406.7},0).wait(1).to({x:412.5},0).wait(1).to({x:418.4},0).wait(1).to({x:424.2},0).wait(1).to({x:430},0).wait(1).to({x:435.8},0).wait(1).to({x:441.6},0).wait(1).to({x:447.4},0).wait(1).to({x:453.3},0).wait(1).to({x:459.1},0).wait(1).to({x:464.9},0).wait(1).to({x:470.7},0).wait(1).to({x:476.5},0).wait(1).to({x:482.3},0).wait(1).to({x:488.2},0).wait(1).to({x:494},0).wait(1).to({x:499.8},0).wait(1).to({x:505.6},0).wait(1).to({x:511.4},0).wait(1).to({x:517.2},0).wait(1).to({x:523},0).wait(1).to({x:528.8},0).wait(1).to({x:534.6},0).wait(1).to({x:540.4},0).wait(1).to({x:546.2},0).wait(1).to({x:552},0).wait(1).to({x:557.8},0).wait(1).to({x:563.6},0).wait(1).to({x:569.4},0).wait(1).to({x:575.2},0).wait(1).to({x:581},0).wait(1).to({x:586.8},0).wait(1).to({x:592.6},0).wait(1).to({x:598.4},0).wait(1).to({x:604.2},0).wait(1).to({x:609.9},0).wait(1).to({x:615.7},0).wait(1).to({x:621.5},0).wait(1).to({x:627.3},0).wait(1).to({x:633.1},0).wait(1).to({x:638.8},0).wait(1).to({x:644.6},0).wait(1).to({x:650.4},0).wait(1).to({x:656.2},0).wait(1).to({x:661.9},0).wait(1).to({x:667.7},0).wait(1).to({x:673.4},0).wait(1).to({x:679.2},0).wait(1).to({x:685},0).wait(1).to({x:690.7},0).wait(1).to({x:696.5},0).wait(1).to({x:702.2},0).wait(1).to({x:708},0).wait(1).to({x:713.7},0).wait(1).to({x:719.5},0).wait(1).to({x:725.2},0).wait(1).to({x:730.9},0).wait(1).to({x:736.7},0).wait(1).to({x:742.4},0).wait(1).to({x:748.1},0).wait(1).to({x:753.8},0).wait(1).to({x:759.6},0).wait(1).to({x:765.3},0).wait(1).to({x:771},0).wait(1).to({x:776.7},0).wait(1).to({x:782.4},0).wait(1).to({x:788.1},0).wait(1).to({x:793.8},0).wait(1).to({x:799.5},0).wait(1).to({x:805.2},0).wait(1).to({x:810.9},0).wait(1).to({x:816.6},0).wait(1).to({x:822.3},0).wait(1).to({x:828},0).wait(1).to({x:833.6},0).wait(1).to({x:839.3},0).wait(1).to({x:845},0).wait(1).to({x:850.6},0).wait(1).to({x:856.3},0).wait(1).to({x:862},0).wait(1).to({x:867.6},0).wait(1).to({x:873.3},0).wait(1).to({x:878.9},0).wait(1).to({x:884.5},0).wait(1).to({x:890.2},0).wait(1).to({x:895.8},0).wait(1).to({x:901.4},0).wait(1).to({x:907.1},0).wait(1).to({x:912.7},0).wait(1).to({x:918.3},0).wait(1).to({x:923.9},0).wait(1).to({x:929.5},0).wait(1).to({x:935.1},0).wait(1).to({x:940.7},0).wait(1).to({x:946.3},0).wait(1).to({x:951.8},0).wait(1).to({x:957.4},0).wait(1).to({x:963},0).wait(1).to({x:968.5},0).wait(1).to({x:974.1},0).wait(1).to({x:979.7},0).wait(1).to({x:985.2},0).wait(1).to({x:990.7},0).wait(1).to({x:996.3},0).wait(1).to({x:1001.8},0).wait(1).to({x:1007.3},0).wait(1).to({x:1012.8},0).wait(1).to({x:1018.3},0).wait(1).to({x:1023.9},0).wait(1).to({x:1029.3},0).wait(1).to({x:1034.8},0).wait(1).to({x:1040.3},0).wait(1).to({x:1045.8},0).wait(1).to({x:1051.3},0).wait(1).to({x:1056.7},0).wait(1).to({x:1062.2},0).wait(1).to({x:1067.6},0).wait(1).to({x:1073.1},0).wait(1).to({x:1078.5},0).wait(1).to({x:1083.9},0).wait(1).to({x:1089.3},0).wait(1).to({x:1094.7},0).wait(1).to({x:1100.1},0).wait(1).to({x:1105.5},0).wait(1).to({x:1110.9},0).wait(1).to({x:1116.3},0).wait(1).to({x:1121.6},0).wait(1).to({x:1127},0).wait(1).to({x:1132.3},0).wait(1).to({x:1137.7},0).wait(1).to({x:1143},0).wait(1).to({x:1148.3},0).wait(1).to({x:1153.6},0).wait(1).to({x:1158.9},0).wait(1).to({x:1164.2},0).wait(1).to({x:1169.5},0).wait(1).to({x:1174.7},0).wait(1).to({x:1180},0).wait(1).to({x:1185.2},0).wait(1).to({x:1190.4},0).wait(1).to({x:1195.7},0).wait(1).to({x:1200.9},0).wait(1).to({x:1206.1},0).wait(1).to({x:1211.2},0).wait(1).to({x:1216.4},0).wait(1).to({x:1221.6},0).wait(1).to({x:1226.7},0).wait(1).to({x:1231.8},0).wait(1).to({x:1237},0).wait(1).to({x:1242.1},0).wait(1).to({x:1247.1},0).wait(1).to({x:1252.2},0).wait(1).to({x:1257.3},0).wait(1).to({x:1262.3},0).wait(1).to({x:1267.3},0).wait(1).to({x:1272.3},0).wait(1).to({x:1277.3},0).wait(1).to({x:1282.3},0).wait(1).to({x:1287.3},0).wait(1).to({x:1292.2},0).wait(1).to({x:1297.1},0).wait(1).to({x:1302},0).wait(1).to({x:1306.9},0).wait(1).to({x:1311.8},0).wait(1).to({x:1316.6},0).wait(1).to({x:1321.4},0).wait(1).to({x:1326.2},0).wait(1).to({x:1331},0).wait(1).to({x:1335.7},0).wait(1).to({x:1340.5},0).wait(1).to({x:1345.2},0).wait(1).to({x:1349.9},0).wait(1).to({x:1354.5},0).wait(1).to({x:1359.1},0).wait(1).to({x:1363.7},0).wait(1).to({x:1368.3},0).wait(1).to({x:1372.8},0).wait(1).to({x:1377.4},0).wait(1).to({x:1381.8},0).wait(1).to({x:1386.3},0).wait(1).to({x:1390.7},0).wait(1).to({x:1395.1},0).wait(1).to({x:1399.4},0).wait(1).to({x:1403.7},0).wait(1).to({x:1408},0).wait(1).to({x:1412.2},0).wait(1).to({x:1416.3},0).wait(1).to({x:1420.5},0).wait(1).to({x:1424.6},0).wait(1).to({x:1428.6},0).wait(1).to({x:1432.5},0).wait(1).to({x:1436.3},0).wait(1).to({x:1439.8},0).wait(1).to({x:1443.2},0).wait(1).to({x:1446.4},0).wait(1).to({x:1449.4},0).wait(1).to({x:1452.3},0).wait(1).to({x:1455},0).wait(1).to({x:1457.6},0).wait(1).to({x:1460.1},0).wait(1).to({x:1462.4},0).wait(1).to({x:1464.7},0).wait(1).to({x:1466.8},0).wait(1).to({x:1468.9},0).wait(1).to({x:1470.8},0).wait(1).to({x:1472.6},0).wait(1).to({x:1474.4},0).wait(1).to({x:1476},0).wait(1).to({x:1477.6},0).wait(1).to({x:1479.1},0).wait(1).to({x:1480.5},0).wait(1).to({x:1481.8},0).wait(1).to({x:1483},0).wait(1).to({x:1484.1},0).wait(1).to({x:1485.2},0).wait(1).to({x:1486.2},0).wait(1).to({x:1487},0).wait(1));

	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#2F3E77").s().dr(-500,-200,1000,400);
	this.shape.setTransform(500,200);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(360));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-1844.4,0,3033.1,400);
...
(lib.erieCLOUD1 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.instance = new lib.eriecloud1("synched",0);
	this.instance.parent = this;
	this.instance.setTransform(141,119.5,1,1,0,0,0,141,119.5);
...
(lib.erieboat1 = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});

	// boat copy
	this.instance = new lib.erieboat_1("synched",0);
	this.instance.parent = this;
	this.instance.setTransform(16,192.5,1,1,0,0,0,161,308.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({regY:308.4,rotation:-1.7,x:16.1,y:196.5},69).to({regX:160.9,rotation:1.7,y:190.6},83).to({regX:161,regY:308.5,rotation:0,x:16,y:192.5},73).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-145,-116,302,339);
...
(lib.Tween56 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.instance = new lib.right3_1("synched",0);
	this.instance.parent = this;
	this.instance.setTransform(327.6,0,1,1,0,0,0,173,137);
	this.instance.alpha = 0.602;

	this.instance_1 = new lib.erieCLOUD1("synched",0);
	this.instance_1.parent = this;
	this.instance_1.setTransform(-359.5,17.5,1,1,0,0,0,141,119.5);
	this.instance_1.alpha = 0.602;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.instance}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-500.5,-137,1001.1,274);


(lib.ERIECANALFINAL = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(190).call(this.frame_190).wait(37));

	// TITLE
	this.instance = new lib.erietitle("synched",0);
	this.instance.parent = this;
	this.instance.setTransform(86.3,-83.3,0.893,0.893,0,0,0,196.3,101.7);
	this.instance.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance).to({alpha:1},52).wait(138).to({startPosition:0},0).wait(37));

	// bird3
	this.instance_1 = new lib.Tween54("synched",0);
	this.instance_1.parent = this;
	this.instance_1.setTransform(-461.1,-85.5,0.642,0.642,0,0,0,-0.1,0);

	this.instance_2 = new lib.Tween55("synched",0);
	this.instance_2.parent = this;
	this.instance_2.setTransform(-399.6,-96.8,0.755,0.755,30,0,0,-0.1,0.1);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({_off:true,regY:0.1,scaleX:0.76,scaleY:0.76,rotation:30,x:-399.6,y:-96.8},49).wait(178));
	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({_off:false},49).to({regX:-0.2,scaleX:0.6,scaleY:0.6,rotation:45,x:-296.7,y:-71.3},52).to({regX:-0.3,regY:0,scaleX:0.54,scaleY:0.54,rotation:15,x:-202.7,y:-82.5},57).to({regX:-0.4,regY:0.1,scaleX:0.27,scaleY:0.27,x:-84.7,y:-112.5},68).wait(1));

	// bird2
	this.instance_3 = new lib.Symbol6();
	this.instance_3.parent = this;
	this.instance_3.setTransform(-414.5,-102.8,0.801,0.801,0,0,0,13.6,11.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({regX:13.2,scaleX:0.64,scaleY:0.64,rotation:45,x:-384.8,y:-119.4},40).to({regX:13.5,regY:11.5,scaleX:0.61,scaleY:0.61,rotation:60,x:-318.1,y:-119.2},41).to({regX:13.4,regY:11.4,scaleX:0.56,scaleY:0.56,rotation:45,x:-270.2,y:-129.4},45).to({regX:13.2,regY:11.5,scaleX:0.43,scaleY:0.43,rotation:15,x:-208.3,y:-129.3},49).to({regX:13,regY:11.2,scaleX:0.24,scaleY:0.24,rotation:30,x:-84,y:-129.4},51).wait(1));

	// bird1
	this.instance_4 = new lib.Tween50("synched",0);
	this.instance_4.parent = this;
	this.instance_4.setTransform(-468.7,-35.9,0.659,0.659);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({regX:-0.1,regY:-0.2,scaleX:0.51,scaleY:0.51,rotation:15,x:-318.4,y:-99.1},63).to({regX:-0.2,scaleX:0.58,scaleY:0.58,rotation:30,x:-245.4,y:-85.2},53).to({scaleX:0.55,scaleY:0.55,rotation:0,x:-168.7,y:-108.9},47).to({regX:-0.5,regY:-0.6,scaleX:0.28,scaleY:0.28,rotation:15,x:-66,y:-122.5},63).wait(1));

	// water strip
	this.instance_5 = new lib.Tween57("synched",0);
	this.instance_5.parent = this;
	this.instance_5.setTransform(2,186.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({regX:0.1,scaleX:1.01,x:1.2,y:198.3},226).wait(1));

	// BOAT-movie
	this.instance_6 = new lib.erieboat1();
	this.instance_6.parent = this;
	this.instance_6.setTransform(6,66.5,0.894,0.894,0,0,0,6,53.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).to({scaleX:1.07,scaleY:1.07,x:6.1,y:53.5},226).wait(1));

	// ground
	this.instance_7 = new lib.Tween59("synched",0);
	this.instance_7.parent = this;
	this.instance_7.setTransform(6,183);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).to({y:193},226).wait(1));

	// bluestrip
	this.instance_8 = new lib.Tween58("synched",0);
	this.instance_8.parent = this;
	this.instance_8.setTransform(5,185.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).to({x:2,y:195.5},226).wait(1));

	// house
	this.instance_9 = new lib.eriehouse_1();
	this.instance_9.parent = this;
	this.instance_9.setTransform(362.5,108,1,1,0,0,0,78.5,75);

	this.timeline.addTween(cjs.Tween.get(this.instance_9).to({scaleX:0.89,scaleY:0.89,x:331.5,y:124},226).wait(1));

	// CLOUDS
	this.instance_10 = new lib.Tween56("synched",0);
	this.instance_10.parent = this;
	this.instance_10.setTransform(11.5,65.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_10).to({scaleY:1.17,y:47.5},226).wait(1));

	// BLUE
	this.instance_11 = new lib.erieblue();
	this.instance_11.parent = this;
	this.instance_11.setTransform(-488,-198);

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(227));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-489,-198,1001.1,416.1);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_1 = function() {
		...
		*/
				...
				function fl_ClickToGoToWebPage5() {
					...
					window.open("exhibitions/votes-for-women", "_self");
				}
	}
	...
	// hudsonvalleyruins
	this.symbol5 = new lib.hudsonvalleyruins();
	this.symbol5.name = "symbol5";
	this.symbol5.parent = this;
	this.symbol5.setTransform(199.5,130,1,1,0,0,0,199.5,130);
	this.symbol5._off = true;
	this.symbol5.visible = false;

	this.timeline.addTween(cjs.Tween.get(this.symbol5).wait(1).to({_off:false},0).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-1344.4,152.9,3892.5,510.3);
// library properties:
lib.properties = {
	...
	manifest: [
		...
		{src:"/sites/all/themes/nysm/homepageanimation/images/erieblue.jpg", id:"erieblue"},
		{src:"/sites/all/themes/nysm/homepageanimation/images/eriebluestrip.jpg", id:"eriebluestrip"},
		{src:"/sites/all/themes/nysm/homepageanimation/images/erieboat.png", id:"erieboat"},
		{src:"/sites/all/themes/nysm/homepageanimation/images/eriehouse.png", id:"eriehouse"},
		{src:"/sites/all/themes/nysm/homepageanimation/images/eriewaterground.png", id:"eriewaterground"},
		...
		{src:"/sites/all/themes/nysm/homepageanimation/images/right3.png", id:"right3"},
		...
		{src:"/sites/all/themes/nysm/homepageanimation/images/title.png", id:"title"},
		{src:"/sites/all/themes/nysm/homepageanimation/images/titlepngcopy.png", id:"titlepngcopy"},
		{src:"/sites/all/themes/nysm/homepageanimation/images/votesforwomenmural.jpg", id:"votesforwomenmural"},
		{src:"/sites/all/themes/nysm/homepageanimation/images/waterstrip.png", id:"waterstrip"},
		{src:"/sites/all/themes/nysm/homepageanimation/images/white3.png", id:"white3"}
	],
	preloads: []
};
