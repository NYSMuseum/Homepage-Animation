...
if (reversed == null) { reversed = false; }
	...
	// open
	this.symbol4 = new lib.wereopen();
	this.symbol4.name = "symbol4";
	this.symbol4.setTransform(501,201,1,1,0,0,0,500,201);
...
p.nominalBounds = new cjs.Rectangle(405,193,600,208);
// library properties:
lib.properties = {
